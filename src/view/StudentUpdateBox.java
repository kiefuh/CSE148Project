...
public class StudentUpdateBox {
	private VBox studentUpdateBox;
	private HBox box1;
	private HBox box2;
	...
	public StudentUpdateBox(PersonBag theBag) {
		this.theBag=theBag;
		studentUpdateBox= new VBox(30);
		studentUpdateBox.setAlignment(Pos.CENTER);
		box1= new HBox(30);
		...
		studentUpdateBox.getChildren().addAll(box1,box2,buttonBox);
	...
	private void setEventListeners() {
		...
		updateButton.setOnAction(e->{
			...
			student=theBag.updateStudent(id, name, major, phoneNumber, miniCourseBag);
			Alert alert2= new Alert(AlertType.INFORMATION);
			alert2.setTitle("Success");
			alert2.setHeaderText("You have successfully updated this student");
	...
	public VBox getStudentUpdateBox() {
		return studentUpdateBox;
	}

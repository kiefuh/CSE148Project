...
public class CourseUpdateBox {
	private VBox courseUpdateBox;
	private HBox box1;
	private HBox box2;
	private HBox box3;
	...
	public CourseUpdateBox(MasterCourseBag theBag) {
		this.theBag=theBag;
		courseUpdateBox= new VBox(30);
		courseUpdateBox.setAlignment(Pos.CENTER);
		...
		courseUpdateBox.getChildren().addAll(box1,box2,box3,buttonBox);
	...
	private void setEventListeners() {
		searchButton.setOnAction(e->{
			...
			courseCreditsField.setText(String.valueOf(course.getNumberOfCredits()));
		...
		updateButton.setOnAction(e->{
			...
			course=theBag.updateCourse(courseNumber, courseTitle, textbookAssigned, courseCredits, courseDescription);
			Alert alert2= new Alert(AlertType.INFORMATION);
			alert2.setTitle("Course Information");
			alert2.setHeaderText("You have updated the course");
	...
	public VBox getCourseUpdateBox() {
		return courseUpdateBox;
	}
